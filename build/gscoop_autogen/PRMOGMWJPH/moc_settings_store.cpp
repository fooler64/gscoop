/****************************************************************************
** Meta object code from reading C++ file 'settings_store.h'
**
...
#include "../../../src/core/settings_store.h"
...
#error "The header file 'settings_store.h' doesn't include <QObject>."
...
void SettingsStore::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (SettingsStore::*)(const AppSettings & )>(_a, &SettingsStore::settingsChanged, 0))
            return;
    }
}
...
// SIGNAL 0
void SettingsStore::settingsChanged(const AppSettings & _t1)
{
