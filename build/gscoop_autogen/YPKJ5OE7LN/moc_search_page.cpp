...
template <> constexpr inline auto SearchPage::qt_create_metaobjectdata<qt_meta_tag_ZN10SearchPageE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'onResultsReady'
        QtMocHelpers::SlotData<void(QVector<ScoopPackage>, bool)>(3, 2, QMC::AccessPrivate, QMetaType::Void, {{
...
void SearchPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->onResultsReady((*reinterpret_cast<std::add_pointer_t<QList<ScoopPackage>>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<bool>>(_a[2]))); break;
        case 2: _t->onInstallClicked(); break;
        case 3: _t->onUninstallClicked(); break;
        case 4: _t->showPackageInfo(); break;
        case 5: _t->onOpFinished((*reinterpret_cast<std::add_pointer_t<ScoopOpType>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<QString>>(_a[2])),(*reinterpret_cast<std::add_pointer_t<bool>>(_a[3])),(*reinterpret_cast<std::add_pointer_t<QString>>(_a[4]))); break;
        default: ;
        }
    }
